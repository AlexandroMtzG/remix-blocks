---
meta:
  title: RemixBlocks - Ready-to-use Remix + Tailwind CSS routes and UI component blocks
  description: RemixBlocks are full-stack, independent of each other and have copy-pasteable code.
headers:
